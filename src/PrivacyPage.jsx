...
function SubSection({ title, children }) {
  return (
    <div style={{ marginBottom: 20 }}>
      <h3 style={{ fontWeight: 600, fontSize: 14, color: COLORS.orange, marginBottom: 8 }}>{title}</h3>
      {children}
    </div>
  );
}
...
function GreenBox({ children }) {
  return (
    <div style={{
      background: "#F0FDF4", border: `1px solid ${COLORS.green}`,
      borderLeft: `4px solid ${COLORS.green}`, borderRadius: 8,
      padding: "14px 18px", marginBottom: 20, fontSize: 13,
      color: COLORS.textSub, lineHeight: 1.7,
    }}>
      {children}
    ...
    <div style={{ minHeight: "100vh", background: COLORS.bg, color: COLORS.textPrimary, fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ background: "#fff", borderBottom: `1px solid ${COLORS.cardBorder}`, padding: "32px 24px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          <h1 style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 28, fontWeight: 700, marginBottom: 8, color: COLORS.textPrimary }}>Privacy Policy</h1>
          <p style={{ fontSize: 13, color: COLORS.textMuted }}>Effective Date: {today} · Last Updated: {today} · btcplanner.ca</p>
        </div>
      </div>
      ...
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "36px 24px" }}>
        ...
        <InfoBox>
          <Strong>BTC Planner respects your privacy.</Strong> This policy explains what we collect, how we use it, and your rights. We collect minimal data, we do not sell it, and you can request deletion at any time.
        </InfoBox>
        ...
        <Section title="1. Who We Are">
          ...
          <P>For privacy-related questions or requests, contact: <Strong>hello@btcplanner.ca</Strong></P>
        </Section>
        ...
        <Section title="5. Cookies & Tracking">
          <SubSection title="5.1 Cookies We Use">
            <ul style={{ marginBottom: 12 }}>
              ...
              <B><Strong>Analytics cookies:</Strong> Anonymous usage data to help us improve the Site.</B>
        ...
        <Section title="6. Third-Party Services">
          ...
          <SubSection title="Affiliate Partners">
            <P>When you click affiliate links (Shakepay, Newton, Ledger, Trezor, Kraken, Coinbase, etc.) you are redirected to third-party sites with their own privacy policies. We are not responsible for their data practices.</P>
          </SubSection>
          ...
          <GreenBox>
            <Strong>We do not sell, rent, trade, or transfer your personal information to third parties for their marketing purposes.</Strong>
          </GreenBox>
        </Section>
        ...
        <Section title="7. Data Retention">
          <ul style={{ marginBottom: 12 }}>
            ...
            <B>Analytics data: 26 months, then auto-deleted</B>
        ...
        <Section title="8. Data Security">
          <P>We protect your information using HTTPS encryption and secure access-controlled hosting. No internet transmission method is 100% secure.</P>
        ...
        <Section title="9. Your Privacy Rights">
          ...
          <SubSection title="9.2 Unsubscribe">
        ...
        <Section title="12. Changes to This Policy">
          <P>We may update this Privacy Policy from time to time. When we make material changes, we will update the effective date above. Continued use of the Site after changes constitutes acceptance of the updated policy.</P>
        </Section>

        <Section title="13. Contact">
          <P><Strong>BTC Planner</Strong><br />
        ...
        <InfoBox>
          We collect minimal data, we do not sell it, we use it only to improve btcplanner.ca, and you can request deletion at any time. Questions? <Strong>hello@btcplanner.ca</Strong>
        </InfoBox>
