        ...
        {activeTab === "dashboard" && (
          <div>
            ...
            <div style={{ background: COLORS.card, border: `1px solid ${COLORS.cardBorder}`, borderRadius: 12, padding: 24 }}>
              ...
              {[
                { step: "1", title: "Buy Bitcoin", body: <>Use a Canadian-friendly exchange like <a href="https://invite.kraken.com/JDNW/rvqfaxbg" target="_blank" rel="noopener noreferrer" style={{ color: COLORS.orange, textDecoration: "underline" }}>Kraken</a> or <a href="https://coinbase.com/join/LJZZEMM?src=ios-link" target="_blank" rel="noopener noreferrer" style={{ color: COLORS.orange, textDecoration: "underline" }}>Coinbase</a>. Fund via Interac e-Transfer or bank deposit and purchase your first Bitcoin.</> },
                ...
                { step: "3", title: "Move to cold storage", body: <>Get a hardware wallet (<a href="https://www.trezor.io" target="_blank" rel="noopener noreferrer" style={{ color: COLORS.orange, textDecoration: "underline" }}>Trezor</a> or <a href="https://shop.ledger.com/?r=a8b2555293e6" target="_blank" rel="noopener noreferrer" style={{ color: COLORS.orange, textDecoration: "underline" }}>Ledger</a>) to store your Bitcoin offline. <a href="https://bitcoin.org/en/secure-your-wallet" target="_blank" rel="noopener noreferrer" style={{ color: COLORS.orange, textDecoration: "underline" }}>Your keys, your Bitcoin</a> — keeping coins on an exchange means you don't truly own them.</> },
              ].map(s => (
